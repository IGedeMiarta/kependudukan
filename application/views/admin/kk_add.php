...
<div class="page-content">
    <div class="container-fluid">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="container">
                    <form action="<?= base_url('admin/kk_act') ?>" method="POST">
                        <div class="row">
                            <div class="col-lg-11">
                                <div class="form-group row">
                                    <label class="col-sm-2 ">NO KK</label>
                                    <div class="col-sm-10">
                                        <input class="form-control" placeholder="Nomer Induk Kartu Keluarga" type="number" name="no_kk">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-2 ">Kepala Keluarga</label>
                                    <div class="col-sm-10">
                                        <input class="form-control" placeholder="Nama Kepala Keluarga" type="text" name="kepala">
                                    </div>
                                </div>
