...
<div class="page-content">
    <div class="container-fluid">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="container">
                    <form action="<?= base_url('admin/rt_rw_act') ?>" method="POST">
                        <div class="row">
                            <div class="col-lg-11">
                                <div class="form-group row">
                                    <label class="col-sm-2 ">RT/RW</label>
                                    <div class="col-sm-10">
                                        <input class="form-control" placeholder="00/00" type="text" name="rt_rw">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-2 ">Ketua RT</label>
                                    <div class="col-sm-10">
                                        <input class="form-control" placeholder="Nama Lengkap" type="text" name="k_rt">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-2 ">Ketua RW</label>
                                    <div class="col-sm-10">
                                        <input class="form-control" placeholder="Nama Lengkap" type="text" name="k_rw">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-sm-2">
