...
<body>
    ...
    <div class="container">
        <center>
            <br><br>
            <font size="3" face="times new roman"><b><u>SURAT KETERANGAN PENDATANG</u><br><br></b></font>
        </center>
        ...
        <table cellspacing="n2" class="table table-borderless table-sm">
            ...
            <tr>
                ...
                <td>:</td>
                <td><?= $datang['tempat_lh'] . ', ' . date('d M Y', strtotime($datang['tgl_lh'])); ?></td>
            </tr>
            <tr>
                <td>Jenis Kelamin</td>
                <td>:</td>
                <td><?php if ($datang['jenkel'] == 'L') {
                        echo 'Laki-laki';
                    } else {
                        echo 'Perempuan';
                    } ?></td>
        ...
        <p>
            Oknum tersebut di atas benar-benar berdominisili / berpindah ke
            <?= $datang['alamat_tinggal'] ?>, lppi Kelurahan Tetandara,
                ...
                <td width="30%">
                    <p align="left">
                        <font size="3" face="times new roman">
                            ...
                            An. LURAH TETANDARA
                            <br> Ub.KASI PEMERINTAH DAN TRANTIB
                            <br><br>
                            <br><br>
                            <b><u>NIKOLAUS IMU, S.Sos</u></b>
                            <br>
                            PENATA MUDA TK.I
                        </font>
