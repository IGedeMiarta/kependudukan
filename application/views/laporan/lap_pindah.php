    ...
    <div class="container-fluid">
        <div class="bred mt-n5 mb-n3 content-right">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Laporan Pindah</li>
            </ol>
        </div>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        ?>
                            <a class='btn btn-primary' target="_blank" href='<?php echo base_url() . 'laporan/lap_pindah_cetak?tanggal_mulai=' . $mulai . '&tanggal_sampai=' . $sampai ?>'><i class='fa fa-print'></i> CETAK</a>
                        <?php
                        }
                        ?>
                    </div>
